...
除去共通的研究背景，三篇论文的主要内容无非各自的方法和结果，这也是比较容易显得分立的部分。因此，所谓“融会贯通”，主要是把三种方法统一到一个框架下。这个框架应该帮助我们比较和分析三种方法。最主要的是回答一个问题，如何从方法的不同解释不同论文结果的差异。这个问题的答案，有助于揭示论文方法的背后的设计思想，也有助于提出未来的研究方向。
